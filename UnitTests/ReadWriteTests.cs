...
namespace UnitTests
{
    ...
    public class ReadWriteTests
    {
        ...
        public void ReadWriteCompressedTest()
        {
            ...
            //CompressingBlockAction encoder = new CompressingBlockAction(1, HashTypes.MD5, Console.WriteLine);
            ...
            //DecompressingBlockAction decoder = new DecompressingBlockAction(1, HashTypes.MD5, Console.WriteLine);
